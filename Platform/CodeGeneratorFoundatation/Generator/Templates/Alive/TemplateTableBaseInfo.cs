...
namespace Alive.Tools.CodeGenerator.Foundatation.Generator.Templates
{
    ...
    /// 表名枚举模板信息
    /// </summary>
    public class TemplateTableBaseInfo : TemplateInfoBase
    {
        #region ==== 构造函数 ====
        ...
        public TemplateTableBaseInfo(string templatePath)
        {
            ...
            //SClassVisibility
            this.SClassVisibility = (QualifierValue)Enum.Parse(typeof(QualifierValue), root.Element("Interface").Attribute("visibility").Value, true);

            //SDocumentComment
            var documentComment = root.Element("Interface").Element("DocumentComment").Elements("Comment");
