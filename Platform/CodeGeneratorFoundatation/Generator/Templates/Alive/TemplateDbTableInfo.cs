...
{
    public class TemplateDbTableInfo : TemplateInfoBase
    {
        #region ==== 构造函数 ====
        ...
        public TemplateDbTableInfo(string templatePath)
        {
            ...
            //SBaseClass
            this.Name = root.Element("Class").Attribute("name").Value;
            ...
            this.MethordOverloadCount = int.Parse(root.Element("Class").Element("Methord").Attribute("overloaded").Value);
        }
        ...
        /// <summary>
        /// 方法重载数(INSERT、UPDATE、DELETE、SELECT)
        /// </summary>
        public int MethordOverloadCount
        {
            get;
            private set;
        }
