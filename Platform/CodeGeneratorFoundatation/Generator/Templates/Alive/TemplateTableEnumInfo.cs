...
namespace Alive.Tools.CodeGenerator.Foundatation.Generator.Templates
{
    ...
    /// 表名枚举模板信息
    /// </summary>
    public class TemplateTableEnumInfo:TemplateInfoBase
    {
        #region ==== 构造函数 ====
        ...
        public TemplateTableEnumInfo(string templatePath)
        {
            ...
            //SClassVisibility
            this.SClassVisibility = (QualifierValue)Enum.Parse(typeof(QualifierValue), root.Element("Enum").Attribute("visibility").Value, true);

            //SDocumentComment
            var documentComment = root.Element("Enum").Element("DocumentComment").Elements("Comment");
