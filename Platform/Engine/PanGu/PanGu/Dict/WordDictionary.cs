...
namespace PanGu.Dict
{
    ...
    public class WordDictionary
    {
        ...
        private WordDictionaryFile LoadFromBinFile(String fileName, out string verNumStr)
        {
            ...
            verNumStr = Framework.Regex.GetMatch("2013", "Pan Gu Segment V(.+)", true);
        ...
        private WordDictionaryFile LoadFromDataFile(List<string> list)
        {
            WordDictionaryFile dictFile = new WordDictionaryFile();
            dictFile.Dicts = new List<WordAttribute>();

            //List<string> list = LoadWordSource.Instance.WordSource();
        ...
        public void Load(List<string> list)
        {
            ...
            List<WordAttribute> waList = LoadFromDataFile(list).Dicts;
