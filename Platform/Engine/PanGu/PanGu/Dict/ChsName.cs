...
namespace PanGu.Dict
{
    ...
    class ChsName
    {
        ...
        private void LoadNameDict(List<string> list, ref Dictionary<char, char> dict)
        {
            dict = new Dictionary<char, char>();
        ...
        /// 数据库中加载数据
        /// </summary>
        public void LoadChsSingleName(List<string> list)
        {
            LoadNameDict(list, ref _SingleNameDict); 
        }

        public void LoadChsDoubleName1(List<string> list)
        {
            LoadNameDict(list, ref _DoubleName1Dict);
        }

        public void LoadChsDoubleName2(List<string> list)
        {
            LoadNameDict(list, ref _DoubleName2Dict);
        }
